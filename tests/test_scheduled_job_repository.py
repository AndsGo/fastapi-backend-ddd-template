...
from app.domain.enums import ScheduledJobRunStatus
from app.infrastructure.persistence.models.scheduled_job import ScheduledJob
from app.infrastructure.persistence.models.scheduled_job_run import ScheduledJobRun
from app.infrastructure.persistence.repositories import (
    scheduled_job_repository as scheduled_job_repository,
)
...
def test_due_jobs_statement_uses_mysql_compatible_null_ordering() -> None:
    now = datetime(2026, 5, 7, 12, 0, tzinfo=UTC)
    ...
    assert "scheduled_jobs.next_run_at IS NULL" in compiled
    assert "scheduled_jobs.next_run_at" in compiled
