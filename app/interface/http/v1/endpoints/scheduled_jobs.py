...
from app.application.dto.scheduled_job import (
    ScheduledJobCreate as CreateScheduledJobCommand,
)
from app.application.dto.scheduled_job import (
    ScheduledJobRunCreate as CreateScheduledJobRunCommand,
)
from app.application.dto.scheduled_job import ScheduledJobUpdate as UpdateScheduledJobCommand
...
from app.interface.http.schemas.scheduled_job import (
    ScheduledJobCreate,
...
from app.interface.http.v1.providers import (
...
def create_job(
    ...
    return use_case.execute(CreateScheduledJobCommand(**payload.model_dump()))
...
def update_job(
    ...
    return use_case.execute(
        job_id,
        UpdateScheduledJobCommand(**payload.model_dump(exclude_unset=True)),
    )
...
def create_run(
    ...
    return use_case.execute(job_id, CreateScheduledJobRunCommand(**payload.model_dump()))
