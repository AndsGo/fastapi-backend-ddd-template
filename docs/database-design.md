...
- Unique string business keys use `app.infrastructure.database.types.case_sensitive_string()`.
...
Alembic migrations live under `app/infrastructure/persistence/migrations`.
